                        ...
                        <a class="nav-link" href="../../main.php">
                            <div class="row">
                                <div class="col-sm-auto">
                                    <img src="../WEB-INF/Logo blanca.png" class="img-fluid d-block shared-style" alt="ScriptForge"  width="50" height="50" onerror="this.onerror=null; this.src='COMPS/WEB-INF/Logo.png';">
                                </div>
                                <div class="col-sm-auto">
                                    Script Forge
                                </div>
